            ...
            <section class="content">
                <header class="content__title">
                    ...
                    <div class="actions">
                        ...
                        <a href="#" class="actio                                         ns__item zmdi zmdi-check-all"></a>
                ...
                <div class="card">
                    <f                                                                                                                 orm name="insererVolontaire" id="formVolontaire" method="POST" action="inserer_Volontaire">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="tab-container">
                                <ul class="nav nav-tabs nav-fill" role="tablist">
                                    <li class="nav-item">
                                        <a class=                                                                                                                                              "nav-link active" data-toggle="tab" hre                                                                                                                                              f="#home-2" role="tab">Informations générales</a>
                                    </li>
                                    <!--                                     <li class="nav-item">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2" name="situaMat">
                                                            ...
                                                            <option>Ma                                                                                                                                                                         rié(e)</option>
                                                            <option>Veuf(ve)</op                                                                                                                                                                                 tion>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
