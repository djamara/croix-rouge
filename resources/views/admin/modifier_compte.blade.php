    ...
    <body data-sa-theme="1">
        <main class="main">
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <form name="gererCompte" id="gererCompte" method="POST" action="/modifier_compte" enctype="multipart/form-data" >
                            @csrf
                                            ...
                                            <div class="row col-sm-12">
                                                ...
                                                <div class="row col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control-lg" name="matricule">
                                                                ...
                                                                @foreach($personne as $personne)
                                                                    <option value="{{$personne->personne_immat}}" <?php if($personne->personne_immat == $compte->persImmat) echo "selected" ?>>{{$personne->personne_immat." | ".$personne->personne_nom." ".$personne->personne_prenom}}</option>
                                                                @endForeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Login</label>
                                                            <input type="hidden" class="form-control form-control-lg" value="{{$compte->idUsers}}" name="idUser" placeholder="Entrez un login" required="">
                                                            <input type="text" class="form-control form-control-lg" value="{{$compte->login}}" name="login" placeholder="Entrez un login" required="">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{$compte->passdecode}}" type="text" class="form-control form-control-lg" name="motdepasse" placeholder="Entrez le mot de passe" required="">
                                                            <i class="form-group__bar"></i>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
